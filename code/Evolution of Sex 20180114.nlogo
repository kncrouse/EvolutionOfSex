...
hosts-own [ allele11 allele12 allele21 allele22 sex my-parasite gestation chance-of-reproduction ]
...
to setup-parasites
  create-parasites 10 [ initialize-parasite ]
end
...
to initialize-parasite
  ...
  set color first allele-color-types - 2 ; ((one-of allele-color-types) - 2)
  set size first parasite-size-types / 3 ; (one-of parasite-size-types) / 3
  set my-host nobody
end
...
to reproduce ;if [my-parasite] of self = nobody
  if random-float 1.0 < chance-of-reproduction [
...
to parasites-reproduce
  ...
  ask my-host [ set chance-of-reproduction chance-of-reproduction / 2 ]
end
...
"blue-large" 1.0 0 -14730904 true "" "plot (count parasites with [ (color = blue - 2) and (size = 1)])"
...
"orange-large" 1.0 0 -6995700 true "" "plot (count parasites with [ (color = orange - 2) and (size = 1)])"
